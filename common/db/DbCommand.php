 ...
 *
 * For more details and usage information on Command, see the [guide article on Database Access Objects](guide:queryRecord-dao).
 *
...
class DbCommand extends Command
{
    ...
    const EVENT_BEFORE_DB_QUERY = 'before.db.query';

    const EVENT_AFTER_DB_QUERY = 'after.db.query';
    ...
    /**
     * @var callable a callable (e.g. anonymous function) that is called when [[\yii\queryRecord\Exception]] is thrown
     ...
     * by its PHP type. You may explicitly specify the PDO type by using a [[yii\queryRecord\PdoValue]] class: `new PdoValue(value, type)`,
     ...
     * of [[yii\queryRecord\Query|Query]] to perform INSERT INTO ... SELECT SQL statement.
     * Passing of [[yii\queryRecord\Query|Query]] is available since version 2.0.11.
     * @return $this the command object itself
     */
     ...
     *     'visits' => 0,
     * ], [
     *     'visits' => new \yii\queryRecord\Expression('visits + 1'),
     * ], $params);
     * ```
     *
     ...
     * @param string $type the column type. [[\yii\queryRecord\QueryBuilder::getColumnType()]] will be called
    ...
    /**
     * Executes a queryRecord command resetting the sequence value of a table's primary key.
    ...
    {
        $this->trigger(self::EVENT_BEFORE_DB_QUERY);
        ...
        $this->trigger(self::EVENT_AFTER_DB_QUERY);
        return $result;
    }
     ...
     *
     * ```php
     * function (\yii\queryRecord\Exception $e, $attempt)
     * {
