...
/**
 * This is the model class for table "suite_corp_program_hit_next_cursor".
 *
 * @property int $id
 ...
 */
class SuiteCorpProgramHitNextCursor extends \common\db\ActiveRecord
{

    public static function tableName()
    {
        return '{{suite_corp_program_hit_next_cursor}}';
    }
