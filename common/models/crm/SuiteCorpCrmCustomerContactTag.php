...
/**
 * 客户联系人标签
 * create table suite_corp_crm_customer_contact_tags
 * (
 ...
 * @property string $group_name varchar(255) default ''  not null comment '标签的分组名称',
 * @property string $tag_name   varchar(255) default ''  not null comment '标签名称',
 ...
 * unique key uk_main (suite_id, corp_id, contact_no, group_name, tag_name)
 * )
 */
class SuiteCorpCrmCustomerContactTag extends \common\db\ActiveRecord
{
    use Helper;
    use CorpNotSoft;
    ...
    {
        return 'suite_corp_crm_customer_contact_tags';
    }
    ...
    {
        return [
            [['suite_id', 'corp_id', 'contact_no'], 'string', 'max' => 50],
            [['group_name', 'tag_name'], 'string', 'max' => 255],
            [['created_at', 'updated_at'], 'integer'],
            [
                ['suite_id', 'corp_id', 'contact_no', 'group_name', 'tag_name'],
                'unique',
                'targetAttribute' => ['suite_id', 'corp_id', 'contact_no', 'group_name', 'tag_name']
            ],
        ];
    }
