...
class WXBizMsgCrypt
{
     ...
     * @param $sTimeStamp int 时间戳，对应URL参数的timestamp
     * @param $sNonce  string 随机串，对应URL参数的nonce
     * @param $sEchoStr string 随机串，对应URL参数的echostr
     * @param $sReplyEchoStr string 解密之后的echostr，当return返回0时有效
     * @return int|mixed 成功0，失败返回对应的错误码
     */
